      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="mt-4 text-gray-400">
              Your personal healthcare companion that understands you.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/use-cases" className="text-gray-400 hover:text-white transition">Use Cases</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/podcast" className="text-gray-400 hover:text-white transition">Podcast</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} Ora AI. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <Link to="/try-ora" className="button-primary">
              Try Ora Free
            </Link>
          </div>
        </div>
